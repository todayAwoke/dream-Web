...
const About = () => {
    return (
        <>
            ...
            <div className='story'>
                <p>The Dream Tutor and Training Service start its journey with the dream. in Addis Ababa Ethiopia in the year 2024 with a vision to empower students and contribute to Ethiopia's socio-economic progress.
                    By providing quality education and skill development programs.</p>
            </div>
